...
//         })
//       } else {
//         setVariations(variations.map(v => (v.id === editingVariation.id ? data[0] : v)))
...
//               <TableCell>
//                 <Button onClick={() => { setEditingVariation(variation); setIsModalOpen(true); }}>Edit</Button>
...
//                 Cancel
//               </Button>
//               <Button onClick={updateVariation}>Save Changes</Button>
//             </div>
//           </div>
//         </div>
//       )}
